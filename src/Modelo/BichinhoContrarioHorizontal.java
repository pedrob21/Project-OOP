...
public class BichinhoContrarioHorizontal extends Personagem {
    ...
    public BichinhoContrarioHorizontal(String sNomeImagePNG, int alcanceEsquerda, int alcanceDireita) {
        super(sNomeImagePNG);
        this.indoEsquerda = false; // ← COMEÇA INDO NA DIREÇÃO CONTRÁRIA
        this.delay = 2;
        this.contador = 0;
